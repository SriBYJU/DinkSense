...
function renderPressFeature(){
  return `<section class="dks-press" aria-labelledby="dks-press-title"><header class="dks-press-head"><div><div class="eyebrow">INTERNATIONAL PRESS</div><h2 id="dks-press-title">As featured on:</h2></div><p>Coverage of the student-built technology portfolio behind DinkSense.</p></header><div class="dks-press-grid"><a class="dks-press-card" href="https://ghananews.org/shriyan-avadhanula-16-year-old-technology-innovator/" target="_blank" rel="noopener noreferrer" aria-label="Read the Ghana News article about Shriyan Avadhanula"><span class="dks-press-logo"><img src="assets/press/ghana-news.jpeg" width="2048" height="2048" alt="Ghana News" loading="lazy" decoding="async"></span><span class="dks-press-copy"><strong>Ghana News</strong><span>Read the article <b aria-hidden="true">↗</b></span></span></a><a class="dks-press-card" href="https://ghanamedia.net/shriyan-avadhanula-16-year-old-innovator-platforms/" target="_blank" rel="noopener noreferrer" aria-label="Read the Ghana Media article about Shriyan Avadhanula"><span class="dks-press-logo"><img src="assets/press/ghana-media.jpeg" width="2048" height="2048" alt="Ghana Media" loading="lazy" decoding="async"></span><span class="dks-press-copy"><strong>Ghana Media</strong><span>Read the article <b aria-hidden="true">↗</b></span></span></a></div></section>`;
}
